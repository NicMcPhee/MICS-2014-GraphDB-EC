...
A graph database is a form of data management system based upon a graph. Information is stored by means of vertices and edges, commonly referred to as nodes and edges, respectively~\cite{GraphDatabases:2013}. In our work, nodes represented individuals, and relationships represented their lineage.
